...
export async function PATCH(
  ...
  try {
    ...
    const parsed = upsertCustomerSiteSettingsSchema.parse({
      ...
      staffingTargetsJson: body?.staffingTargetsJson,
      heroHeadline: body?.heroHeadline,
      heroSubheading: body?.heroSubheading,
      homepageHeroImageUrl: body?.homepageHeroImageUrl,
      setupGuidanceEnabled: body?.setupGuidanceEnabled,
    ...
    const settings = await upsertCustomerSiteSettings(resolved.tenantSiteId, {
      ...
      staffingTargetsJson: parsed.staffingTargetsJson,
      heroHeadline: parsed.heroHeadline,
      heroSubheading: parsed.heroSubheading,
      homepageHeroImageUrl: parsed.homepageHeroImageUrl,
      setupGuidanceEnabled: parsed.setupGuidanceEnabled,
