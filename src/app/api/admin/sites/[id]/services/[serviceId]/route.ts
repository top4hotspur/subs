...
import { deleteCustomerSiteService } from "@/lib/sites/customer-site-settings-repository";
...
export async function DELETE(
  ...
  try {
    ...
    const removed = await deleteCustomerSiteService(id, serviceId);
    if (!removed) {
    ...
    return NextResponse.json(
      {
        ok: false,
        error: "SITE_SERVICE_DELETE_FAILED",
