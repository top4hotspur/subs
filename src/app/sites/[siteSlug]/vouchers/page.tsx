  ...
  return (
    <main className="min-h-screen bg-slate-50 px-4 py-10 text-slate-900 sm:px-6 lg:px-8">
      <div className="mx-auto max-w-3xl">
        <Link href={publicBasePath || "/"} className="text-sm font-semibold text-slate-600 hover:text-slate-900">
          Back to {siteName}
        </Link>
        ...
        <div className="mt-6">
          <PublicGiftVoucherForm siteSlug={preview.tenantSite.slug} siteName={siteName} settings={settings} publicBasePath={publicBasePath} />
        </div>
      </div>
    </main>
  );
